...
using MBaumann.ConfNet.WebMvc.Models.ManageViewModels;
using MBaumann.ConfNet.WebMvc.Services;
...
namespace MBaumann.ConfNet.WebMvc.Controllers
{
    ...
    public class ManageController : BaseController
    {
        ...
        public ManageController(
            ILogger<ManageController> pLogger,
            UserManager<ApplicationUser> userManager,
            SignInManager<ApplicationUser> signInManager,
            IEmailSender emailSender,
            UrlEncoder urlEncoder) : base(pLogger)
        {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("MBaumann.ConfNet.WebMvc"),
